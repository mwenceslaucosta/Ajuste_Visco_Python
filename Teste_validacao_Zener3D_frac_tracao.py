...
Utilizar rotina do matlab: Teste_Zener3D_frac_com_implementaca_python
"""
import math 
import numpy as np
from matplotlib import pyplot as plt
from modulo_ensaios import Ensaio_tracao
from modulo_modelosZener3D_infinitesimal import ModeloZener3D_frac_infini
...
config['k_bracos']=2
config['poisson']=0.46
material=ModeloZener3D_frac_infini(config)

# Parametos materiais de teste 
x=np.array([3.84, 38.46, math.log10(1),0.6, 38.46/2, math.log10(0.5),0.5])
